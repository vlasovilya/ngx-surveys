    ...
    drawCanvas(): void {
        ...
        let loop=()=>{
            for (var i = 0; i < numMetaballs; i++) {
                ...
                metaball.r=metaball.tOrigin+((this.voiceVar || 0)*7);
                metaball.x += metaball.vx;
                metaball.y += metaball.vy;
                //console.log(metaball.r);
